...
original_prompt = "Hey Miles! What can Fossick translate for you today?"
...
if not original_text:
    ...
    first_pass_translation_persona = f"You are a {input_language} to {output_language} translator. When provided a document segment, you will translate while trying to maintain tone and accuracy."
    second_pass_translation_persona = f"You are going to be presented a section of text in {input_language} and translated to {output_language}. Review the translation and try to make improvements. Output the entire {output_language} translation with improvements. Only output the complete text, do not add commentary on what changed."
    review_persona = "You are being provided with excerpts of an original text and a translated text. Rate the quality of the translation for content and tone on a scale from 1 to 10 with 1 meaning terrible and 10 meaning perfect. Offer a very brief explaination of why."
